...
// a full solution for string manipulation and internationalization.
    ...
    function Datepicker() {
        ...
        this.regional[""] = {// Default regional settings
            ...
            dayNamesMin: ["Do", "Lu", "Mr", "Mi", "Ju", "Vi", "Sa"], // Column headings for days starting at Sunday
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
            ...
            if (secondary || !changeMonth) {
                ...
                monthHtml += "<select class='ui-datepicker-month form-control col-md-2' style='width:50%' data-handler='selectMonth' data-event='change'>";
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    ...
                    inst.yearshtml += "<select class='ui-datepicker-year form-control col-md-2' style='width:50%' data-handler='selectYear' data-event='change'>";
